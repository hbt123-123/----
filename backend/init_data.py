    ...
    templates = [
        {
            ...
            'name': '大创项目',
            'stages': [
                {'order': 1, 'name': '申报阶段', 'duration_days': 30,
                 'materials': ['项目申报书', '诚信承诺书', '汇总表'], 'need_defense': False},
                {'order': 2, 'name': '中期检查', 'duration_days': 90,
                 'materials': ['中期检查报告', '阶段性成果'], 'need_defense': False},
                {'order': 3, 'name': '结题答辩', 'duration_days': 60,
        ...
        },
        {
            ...
            'name': '挑战杯',
            'stages': [
                {'order': 1, 'name': '院级申报', 'duration_days': 20,
                 'materials': ['作品申报书', '汇总表'], 'need_defense': False},
                {'order': 2, 'name': '校级答辩', 'duration_days': 30,
        ...
        },
        {
            ...
            'name': '寒暑期社会实践',
            'stages': [
                {'order': 1, 'name': '立项申报', 'duration_days': 15,
                 'materials': ['立项申报书', '安全责任书'], 'need_defense': False},
                {'order': 2, 'name': '实践开展', 'duration_days': 45,
                 'materials': ['实践日志', '新闻稿'], 'need_defense': False},
                {'order': 3, 'name': '总结评比', 'duration_days': 20,
